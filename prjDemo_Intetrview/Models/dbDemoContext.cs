...
namespace prjDemo_Intetrview.Models
{
...
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TCustomer>(entity =>
            {
                ...
                entity.Property(e => e.FCustomerImg)
                    .HasMaxLength(50)
                    .HasColumnName("fCustomerImg");
            ...
            modelBuilder.Entity<TEmployee>(entity =>
            {
                ...
                entity.Property(e => e.FEmployeeImg)
                    .HasMaxLength(50)
                    .HasColumnName("fEmployeeImg");
            ...
            modelBuilder.Entity<TProduct>(entity =>
            {
                ...
                entity.Property(e => e.FProductImg)
                    .HasMaxLength(50)
                    .HasColumnName("fProductImg");
